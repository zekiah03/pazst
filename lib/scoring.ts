import { AxisKey, AxisResult, Question } from './types';
import { axisDefs } from './axes';
import { questions } from './questions';

export function computeResults(answers: number[]): AxisResult[] {
